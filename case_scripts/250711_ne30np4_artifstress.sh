...
CASENAME="b.e23.BMOM.ne30np4_sx0.66av1.aqua.production.250711_artifstress"
CLONENAME="b.e23.BMOM.ne30np4_sx0.66av1.aqua.production.250127_h80l895"
...
scp ${DIAGSRC}/250711_diag_table_hifreq ./SourceMods/src.mom/diag_table
...
#impose artificial cyclonic zonal sfc stress rectangle
scp ${DIAGSRC}/MOM_vert_friction.F90.artifstress ./SourceMods/src.mom/MOM_vert_friction.F90

#Disable ocean state checksum and include rho2 diagnostics
scp ${DIAGSRC}/user_nl_mom ./

#Make sure hm files are moved to archive
...
#Stage restarts
scp /glade/campaign/univ/upsu0063/b.e23.BMOM.ne30np4_sx0.66av1_rest/*.r*."${RESTDATE}"-00000.nc "${RUNDIR}"
scp /glade/campaign/univ/upsu0063/b.e23.BMOM.ne30np4_sx0.66av1_rest/rpointer.* "${RUNDIR}"

#If using a different ocean state
...
scp /glade/work/jpan/ocean_rho2_190917.nc "${RUNDIR}"/INPUT

cat > user_nl_cam <<EOF
nhtfrq=0,-6,-1
mfilt=0,1,24
fincl1='CAPE:A'
fincl2='UBOT:I','VBOT:I','Z300:I','SST:I','Q850:I','PS:I','PSDRY:I','PRECT:I','U850:I','V850:I','PSL:I','TBOT:I','T850:I','UBOT:I','VBOT:I','TMQ:I','Z500:I','U200:I','V200:I','OMEGA500:I','OMEGA850:I','T200:I','T500:I','U500:I','V500:I', 'TAUX:I', 'TAUY:I', 'FLUT:I', 'Z850:I', 'CAPE:I'
...
./xmlchange JOB_PRIORITY=main

./xmlchange --subgroup case.run PROJECT=$USEPROJ

./xmlchange --subgroup case.st_archive PROJECT=$USEPROJ

./xmlchange --subgroup case.run JOB_WALLCLOCK_TIME=0:05:00

./xmlchange --subgroup case.st_archive JOB_WALLCLOCK_TIME=0:01:00
