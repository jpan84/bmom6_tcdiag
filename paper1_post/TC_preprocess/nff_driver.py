...
for ar in ARCHRT:
   ...
   subprocess.Popen(f"UQSTR='{casenm}' PATHTOFILES='{atmpth}' FILTVARS='{filtvars}' GCD={rgcd} SPTH={wspd} INVERT={int(invert)} ./nff_gen_TC_masks.sh &> nffout.{casenm}", shell=True)
