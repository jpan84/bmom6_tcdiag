...
CASENAME="b.e23.BMOM.ne30np4_sx0.66av1.aqua.production.250411_unseed"
...
HTRACKSTR = "h1i"
vortex_namelist = /glade/u/home/jpan/work/betacast-pivot/py_atm_to_cam/tcseed/unseed.ape.nl.025.0
do_seed = false
...
cd $SEEDDRVDIR
###./case.submit
./tc-seed-driver.sh.250411_unseed_sznl $CASEDIR/config.unseed
