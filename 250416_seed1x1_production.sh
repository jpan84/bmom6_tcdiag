###Production run of unseeding in ne120np4
#!/bin/bash

set -e

CASENAME="b.e23.BMOM.ne120np4_sx0.66av1.aqua.production.250416_seed1x1"
...
HTRACKSTR = "h1i"
vortex_namelist = /glade/u/home/jpan/work/betacast-pivot/py_atm_to_cam/tcseed/seed.ape.nl.250129_ne120np4_seed1x1
do_seed = true
NSEEDS = 1
