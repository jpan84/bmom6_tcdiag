###Low-cost low-res test of production pipeline
#!/bin/bash

set -e

CASENAME="b.e23.BMOM.ne30np4_sx0.66av1.aqua.production.250411_seed1x1"
CLONENAME="b.e23.BMOM.ne30np4_sx0.66av1.aqua.production.250130_h80l89"
...
scp ${DIAGSRC}/250129_diag_table_dlyrest ./SourceMods/src.mom/diag_table
...
HTRACKSTR = "h1i"
vortex_namelist = /glade/u/home/jpan/work/betacast-pivot/py_atm_to_cam/tcseed/seed.ape.nl.250410_ne30np4_seed1x1
do_seed = true
NSEEDS = 1
...
echo "Cron jobs created to compute MOM monthly averages, compress history, and compress st restarts."
echo "Run crontab -e to view or remove these jobs."

cd $SEEDDRVDIR
###./case.submit
./tc-seed-driver.sh.250411_seed_sznl $CASEDIR/config.seed
