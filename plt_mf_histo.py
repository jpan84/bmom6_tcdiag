...
FILI = 'UMF850_0012dd01_00-30warm.nc'
DIRO = 'mf_histo_btbc'
THEVAR = FILI.split('_')[0]
...
subplot_kw = dict(xlim=(-.5, 0), ylim=(-.5, 0))
pckw = [dict(cmap='seismic', vmin=-2e12, vmax=2e12), dict(cmap='nipy_spectral'), dict(cmap='seismic', vmin=-2e12, vmax=2e12)]
...
for ii, ax in enumerate(axes):
   ...
   pc = ax.pcolormesh(ds['OM850'], ds['OM500'], pltda, shading='nearest', **pckw[ii])
