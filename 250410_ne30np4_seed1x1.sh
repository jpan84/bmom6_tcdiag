...
CASENAME="b.e23.BMOM.ne30np4_sx0.66av1.aqua.production.250410_seed1x1"
...
./xmlchange --subgroup case.run JOB_WALLCLOCK_TIME=0:10:00
...
cd $SEEDDRVDIR
###./case.submit
./tc-seed-driver.sh.250410_bmom_sznl $CASEDIR/config.seed
